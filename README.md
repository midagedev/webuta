...
- Japanese UTAU alias compatibility for direct kana lyrics, basic romaji CV lyrics, and common yoon forms such as `kya`, `shu`, `ja`, `cho`, and `ryo`, including hiragana/katakana alias normalization.
