...
- Unit coverage re-imports the DAW bundle's native `.webutau.json`, USTX, and classic UST exports, then verifies the starter lyric, pitch, timing, BPM, and chord guide survive the handoff.
