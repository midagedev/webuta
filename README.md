...
- Unit tests verify UST `Intensity`, `Velocity`/`Modulation`/`Flags`, timing overrides, `Envelope`, and classic pitch-bend curves round-trip and affect rendered output where supported.
