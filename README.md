...
- Community release readiness card that separates automated V3 checks from the required human listening scorecard and DAW handoff evidence, with an explicit `자동 3/3 통과 · 수동 0/2 남음` manual-evidence checklist.
