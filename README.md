...
- Piano-roll note editing with draw, drag, resize, duplicate, split, delete, keyboard movement, undo, redo, and an arrangement chord lane that keeps the starter `Am -> F -> C -> G` guide aligned to the vocal timeline.
