...
- Piano-roll note editing with draw, drag, resize, split, delete, keyboard movement, undo, and redo.
...
- Native `.webutau.json` project save/import, plus USTX import/export for OpenUtau handoff.
...
- `WebUtau Korean V3 Synthetic` is a license-clean generated starter voicebank, not a commercial neural singer or a human recording.
