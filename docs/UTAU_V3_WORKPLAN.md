...
Hard constraint: the user will not provide singer recordings. V3 must therefore
be generated by WebUtau tooling itself. The primary V3 path is a fully synthetic,
original DSP-generated singer, not a recorded singer and not a cloned third-party
voice.
