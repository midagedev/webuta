...
async function waitForAppReady(page) {
  ...
  await page.getByLabel('First run guide').getByText('VOCAL STARTER').waitFor({ timeout: DEFAULT_TIMEOUT_MS })
  ...
  await page.getByLabel('Starter next action').getByText('다음 행동').waitFor({ timeout: DEFAULT_TIMEOUT_MS })
