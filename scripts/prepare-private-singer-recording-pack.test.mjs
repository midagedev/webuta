...
describe('private singer recording pack preparation', () => {
  ...
  it('can generate a reviewed local-training registry from the command line', () => {
    ...
    expect(readme).toContain('npm run experimental:neural:audit-prompt-coverage')
    expect(readme).toContain('npm run experimental:neural:prepare-guides')
    expect(readme).toContain('npm run experimental:neural:serve-recorder')
    expect(readme).toContain('npm run experimental:neural:audit-recordings')
