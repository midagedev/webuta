...
function readmeForPack(sessionPlan, outDir, registryOut) {
  return [
    ...
    '',
    '```sh',
    'npm run experimental:neural:audit-prompt-coverage -- \\',
    ...
    '',
    '```sh',
    'npm run experimental:neural:prepare-guides -- \\',
    `  --pack-dir ${relativePath(outDir)}`,
    '```',
    '',
    ...
    '',
    '```sh',
    'npm run experimental:neural:serve-recorder -- \\',
    `  --pack-dir ${relativePath(outDir)}`,
    '```',
    '',
    ...
    '',
    '```sh',
    'npm run experimental:neural:audit-recordings -- \\',
    `  --pack-dir ${relativePath(outDir)} \\`,
